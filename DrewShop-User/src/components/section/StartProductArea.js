...
class StartProductArea extends Component{
    render(){
        return(
        ...
        <div className="container">
            ...
            <div className="col-12">
                ...
                <div className="nav-main">
                    ...
                    <li className="nav-item"><a className="nav-link active" data-toggle="tab" href="#man" role="tab">Hoodie</a></li>
                    <li className="nav-item"><a className="nav-link" data-toggle="tab" href="#women" role="tab">T-Shirt</a></li>
                    <li className="nav-item"><a className="nav-link" data-toggle="tab" href="#kids" role="tab">Slippers</a></li>
                    </ul>
                    {/*/ End Tab Nav */}
                </div>
...
export default StartProductArea